  ...
  \KeywordTok{rebase}\NormalTok{ (}
    \ControlFlowTok{function}\NormalTok{ (sizes, rates) \{}
      \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{length}\NormalTok{ (rates) }\OperatorTok{!=}\StringTok{ }\DecValTok{1}\NormalTok{) \{}
        \KeywordTok{stop}\NormalTok{ (}\StringTok{"Error: the population partition is not}
\StringTok{              a }\CharTok{\textbackslash{}"}\StringTok{refinement}\CharTok{\textbackslash{}"}\StringTok{ of the rate partition"}\NormalTok{)}
\NormalTok{      \}}
